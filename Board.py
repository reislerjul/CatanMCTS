...
class Board():
    ...
    def get_cost(self, player):
        ...
        cost = 0.0
        die_roll_probs = {2:1, 3:2, 4:3, 5:4, 6:5, 8:5, 9:4, 10:3, 11:2, 12:1}
        ...
        for resource in player.resources.keys():
            num_res = num_res + player.resources[resource]
            if num_res <= 7:
